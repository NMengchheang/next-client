...
export default function MockProductPageBackUp() {
                    ...
                    products.map(product => (
                        <div key={product.id} className="w-full max-w-sm bg-white border border-gray-200 rounded-lg shadow-sm dark:bg-gray-800 dark:border-gray-700">
                            ...
                            <div className="px-5 pb-5">
                                    ...
                                    <span className="text-xl text-gray-900 dark:text-white mb-1">${(product.price).toFixed(2)}</span>
                                    <div className="flex items-center justify-between">
                                        ...
                                        <button onClick={() => addItemToCart(product)} className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                                            Add to cart
                                        </button>
                                    </div>
                            </div>
